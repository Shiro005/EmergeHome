...
const Home = () => {
  ...
  const banners = [
  {
    ...
    subtitle: "Our team of experts handpicks the best products from Amazon, Flipkart & Meesho for guaranteed quality",
    bgImage: "https://images.pexels.com/photos/1087727/pexels-photo-1087727.jpeg",
    buttonText: "Shop Curated Collection",
    buttonColor: "bg-amber-500 text-white hover:bg-amber-600 hover:shadow-lg transition-all duration-300",
    icon: <BadgeCheck className="w-12 h-12 text-amber-400" />,
    overlay: "bg-gradient-to-br from-gray-900/40 to-gray-800/40",
    ...
    partners: [
      ...
      { 
        name: "Meesho", 
        logo: "https://images.seeklogo.com/logo-png/43/1/meesho-logo-png_seeklogo-438533.png" 
      }
    ],
    accentColor: "amber"
  },
  {
    ...
    subtitle: "Zero inventory, zero middlemen - we connect you directly with trusted retailers for the best prices",
    bgImage: "https://images.pexels.com/photos/6309756/pexels-photo-6309756.jpeg",
    buttonText: "Explore Best Deals",
    buttonColor: "bg-orange-500 text-white hover:bg-orange-600 hover:shadow-lg transition-all duration-300",
    icon: <ThumbsUp className="w-12 h-12 text-orange-600" />,
    overlay: "bg-gradient-to-br from-gray-900/40 to-gray-800/40",
    textColor: "text-white",
    badge: "Direct Connect",
    badgeColor: "bg-orange-500/20 text-orange-300 border border-orange-400/30",
    highlight: "No Hidden Costs",
    highlightColor: "bg-orange-500/20 text-orange-300 border border-orange-400/30",
    accentColor: "orange"
  },
  {
    id: 3,
    title: "Premium Quality Standards",
    subtitle: "Only products with 4.5+ ratings and verified reviews make it to our premium collection",
    bgImage: "https://images.pexels.com/photos/31356716/pexels-photo-31356716.jpeg",
    buttonText: "View Premium Range",
    buttonColor: "bg-orange-500 text-white hover:bg-orange-600 hover:shadow-lg transition-all duration-300",
